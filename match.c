...
int main (int argc, char **argv)
{
    ...
    */
    ...
    printf(" porgression du matching ...... \n");

//Chemin du fichier 
    char* pChemin="/home/selain/Bureau/tp/fichier_score.txt";
	FILE *pFichier=fopen(pChemin,"a+");
	if(pFichier){
	fprintf(pFichier,"%s %s %f\n",argv[2],argv[6],count/n); 
	}
	else{
